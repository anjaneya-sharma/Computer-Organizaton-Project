...
def func_typ_A(argument,prog_counter):
    ...
    re1=int(Reg_bin_val[ir1],2)
    re2=int(Reg_bin_val[ir2],2)
...
def func_type_E(argument,prog_counter):
    ...
    ret_str=str((prog_counter.zfill(8))+" "+Reg_bin_val[0].zfill(16)+" "+Reg_bin_val[1].zfill(16)+" "+Reg_bin_val[2].zfill(16)+" "+Reg_bin_val[3].zfill(16)+" "+Reg_bin_val[4].zfill(16)+" "+Reg_bin_val[5].zfill(16)+" "+Reg_bin_val[6].zfill(16)+" "+Reg_bin_val[7].zfill(16))
